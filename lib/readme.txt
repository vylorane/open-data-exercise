...
- [unfoldingworld](https://github.com/tillnagel/unfolding/releases/download/v0.9.6/unfolding_app_template_with_examples_0.9.6.zip) - expand zip to access jar files
